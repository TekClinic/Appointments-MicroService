...
func (c *appointmentsServiceClient) EditAppointment(ctx context.Context, in *EditAppointmentRequest, opts ...grpc.CallOption) (*EditAppointmentResponse, error) {
	out := new(EditAppointmentResponse)
	err := c.cc.Invoke(ctx, "/appointments.AppointmentsService/EditAppointment", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAppointmentsServiceServer) EditAppointment(context.Context, *EditAppointmentRequest) (*EditAppointmentResponse, error) {
...
func _AppointmentsService_EditAppointment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(EditAppointmentRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AppointmentsServiceServer).EditAppointment(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/appointments.AppointmentsService/EditAppointment",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AppointmentsServiceServer).EditAppointment(ctx, req.(*EditAppointmentRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AppointmentsService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AppointmentsService_EditAppointment_Handler,
		},
	},
